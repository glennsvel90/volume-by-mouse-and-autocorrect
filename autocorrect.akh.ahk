...
;be able to use the side mouse button to locate the mouse pointer after mouse control button location finder setting is set on
;this makes the control button + semicolon button combo key combination makes a press simulation of just a control button
^;::
send, {ctrl}
...
;google translate a copied text
;control+ alt+ g
^!g::
send, #{TAB}
...
;---CODE BLOCK INSERT KEYBOARD SHORTCUT-- After typing th backward apostrophe 4 times, press enter
